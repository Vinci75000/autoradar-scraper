...
SOURCES: dict[str, SourceConfig] = {
    ...
    # ═══════════════════════════════════════════════════════════════════════
    # Sprint A4-Italy — 9 dealers IT (3 ready cohorte 1 + 6 manual_inspect)
    # ═══════════════════════════════════════════════════════════════════════
    ...
    "cavauto": {
        ...
        "listings_url": "https://www.cavauto.com/auto/?state=used",
    ...
    "omar-forlini": {
        ...
        "listings_url": "https://www.omarforlini.com/auto-usate/",
        "sitemap_url": "https://www.omarforlini.com/auto-sitemap.xml",
        "url_pattern": r"/auto/[a-z0-9-]+-\d+/?$",
        ...
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy. WP+Elementor+SiteGround. JSON-LD @graph minimal Yoast → fallback HTML. Sitemap /auto-sitemap.xml dédié. 39 cars confirmées via probe.",
    },

    "ruote-da-sogno": {
        "slug": "ruote-da-sogno",
        "display_name": "Ruote Da Sogno",
        "domain": "ruotedasogno.com",
        "base_url": "https://www.ruotedasogno.com",
        "listings_url": "https://www.ruotedasogno.com/fr/tipo/auto/",
        "sitemap_url": "https://www.ruotedasogno.com/sitemap.xml",
        "url_pattern": r"/fr/veicolo/[a-z0-9-]+/?$",
        "country": "Italie", "city": "Reggio Emilia",
        "currency": "EUR", "language": "it", "timezone": "Europe/Rome",
        "tier": 1, "type": "dealer",
        "specialty": "Motor Valley reference",
        "brand_focus": ["Ferrari", "Alfa Romeo", "Mercedes-Benz", "Porsche", "Fiat", "BMW"],
        "estimated_stock": 320,
        "scrape_method": "httpx_bs4",
        "extraction": "gestionaleweb",
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy. WP+Yoast. /fr/tipo/auto/ filter cars-only natif. Bypass C&C aggregator (Cloudflare levée 2026-05-10).",
    },
    ...
    "romagna-motorsport": {
        ...
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy manual_inspect. Depuis 1986. 12 F50 + 16 Lancia Delta Integrale en 12 mois. CSS a sniffer.",
    },
    ...
    "ferri-auto": {
        ...
        "domain": "ferriauto.it",
        "base_url": "https://www.ferriauto.it",
        "country": "Italie", "city": "Modena",
        "currency": "EUR", "language": "it", "timezone": "Europe/Rome",
        "tier": 1, "type": "dealer",
        "specialty": "Multimarca premium Modena centro (1966)",
        "brand_focus": ["Ferrari", "Lamborghini", "Porsche", "Mercedes-Benz",
                        "Jaguar", "BMW", "Audi", "Mini"],
        "estimated_stock": 30,
        "scrape_method": "httpx_bs4",
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy manual_inspect. Depuis 1966 (60 ans). Capitale dei motori, Piazzale Risorgimento. CSS a sniffer.",
    },
    ...
    "mormancar": {
        ...
        "brand_focus": ["Aston Martin", "Bentley", "Ferrari", "Lamborghini",
                        ...
                        "Mercedes-Benz", "BMW", "Audi", "Maybach"],
        "estimated_stock": 25,
        "scrape_method": "httpx_bs4",
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy manual_inspect. Cinque soci, luxury Brescia. CSS a sniffer.",
    },
    ...
    "autoluce": {
        ...
        "brand_focus": ["Alfa Romeo", "Aston Martin", "Audi", "Autobianchi",
                        ...
                        "Lamborghini", "Lancia", "Maserati", "Mercedes-Benz",
                        "Mini", "Porsche"],
        "estimated_stock": 55,
        "scrape_method": "httpx_bs4",
        "score_bonus": 5,
    ...
    "luzzago-1975": {
        ...
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy manual_inspect. Depuis 1975 Brescia. Distinct de Cristiano Luzzago (1978). CSS a sniffer.",
    },
    ...
    "city-motors-torino": {
        ...
        "score_bonus": 5,
        "selectors": {},
        "notes": "A4-Italy manual_inspect. Depuis 1987. Anni 30+, fiera Bologna ogni anno. CSS a sniffer.",
    },
