...
CANDIDATS = [
    ("Mirbach",              "https://www.mirbach.de"),
    ("Wallner Classic",      "https://www.wallnerclassic.de"),
    ("Cargold Collection",   "https://www.cargold-collection.com"),
    ("Motorlegenden",        "https://motorlegenden.de"),
    ("dreikommazwei",        "https://www.dreikommazwei.de"),
    ("Sporting Cars",        "https://www.sportingcars.de"),
    ("OM Automobile",        "https://www.om-automobile.de"),
    ("Noris Classic Cars",   "https://www.noris-classic-cars.com"),
    ("Mechatronik",          "https://www.mechatronik.de"),
    ("Heusel Classic",       "https://www.heusel-classic.de"),
    ("Ande Votteler",        "https://andevotteler.net"),
    ("DLS Automobile",       "https://dls-automobile.com"),
    ("Classic-Line",         "https://www.classic-line.org"),
    ("Fine Cars Bodensee",   "https://finecars-bodensee.de"),
    ("JKS Classic Cars",     "https://www.jks-classic-cars.com"),
    ("Turmgarage",           "https://turmgarage.com/"),
    ("C.O.G. Classics",      "https://www.cog-classics.com/de"),
    ("Levy Classic Cars",    "https://www.levyclassiccars.de/"),
    ("Janssen Classics",     "https://sl-w107.de/"),
    ("Pyritz Classics",      "https://pyritz-classics.de/"),
    ("movisti",              "https://www.movisti.de/"),
    ("Matthias Muck",        "https://muck-automobile.de/"),
    ("Koch Klassik",         "https://koch-klassik.de/"),
    ("Automobile Gath",      "https://www.automobile-gath.de/"),
    ("Rheingold Classics",   "https://rheingold-classics.de/"),
    ("DEPOT3",               "https://www.depot3.de/"),
    ("Thiesen Hamburg",      "https://www.thiesen-automobile.com/"),
    ("Eberhard Thiesen",     "https://eberhard-thiesen.de/"),
    ("Kultgarage",           "https://kultgarage.de/"),
    ("Steenbuck",            "https://steenbuck-automobiles.de/"),
    ("Fineeleven",           "https://fineeleven.com/"),
    ("LegendenWerk",         "https://legendenwerk.de/"),
    ("Seeland Porsche",      "https://www.seeland-klassische-porsche.de/"),
    ("MEMENTO Classic",      "https://www.memento-classic.de/"),
    ("Classic Cars Heide",   "https://motorwagen.com/"),
    ("Herr Stern",           "https://www.herrstern.de/"),
    ("Atelier Automobile",   "https://www.atelier-automobile.de/"),
    ("Sportwagenclassics",   "https://www.sportwagenclassics.de/"),
    ("DB Classic Cars",      "https://www.db-classic-cars.de/"),
    ("Dresdner Klassiker",   "https://klassiker-handel.de/"),
    ("AutoTradition",        "https://www.autotradition.de/"),
]
