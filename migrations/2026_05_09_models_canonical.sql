...
-- Patch GRANTs (ajout 2026-05-09)
GRANT SELECT, INSERT, UPDATE, DELETE ON public.models_canonical TO service_role;
GRANT SELECT ON public.models_canonical TO anon, authenticated;
GRANT USAGE, SELECT ON SEQUENCE models_canonical_id_seq TO service_role;
